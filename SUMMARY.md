...
- [Model routing](ai/ai_infra/model_routing.md)

# Model performance

## Concepts

- [Token concept](ai/model_performance_evaluation/token_concept.md)

## Benchmarking and leaderboards

- [Model performance and leaderboards](ai/model_performance_evaluation/model_performance_and_leaderboards.md)

## Inference systems

- [Inference performance research](ai/model_performance_evaluation/inference_performance_research.md)

# Model evaluation and RCA

## Evaluation methodology

- [Model evaluation outline](ai/model_evaluation/outline.md)

## Trace-based diagnosis

- [Trace-based RCA](ai/model_evaluation/trace_based_rca.md)
- [Trace Skill and MCP analysis](ai/model_evaluation/trace_skill_mcp_analysis.md)
